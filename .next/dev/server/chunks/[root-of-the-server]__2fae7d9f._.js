...
async function POST(req) {
    try {
        ...
        const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getAdminByUsername(username);
        ...
        const valid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, admin.passwordHash);
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$auth$2d$helper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])({
            id: admin.id,
            username: admin.username,
            role: 'admin'
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fae7d9f._.js.map