...
"[project]/server/s2s.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function generateS2SToken(oiSession, secret) {
    if (!secret) return "";
    return __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac("sha256", secret).update(oiSession).digest("hex");
}
function verifyS2SToken(providedToken, oiSession, secret) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].timingSafeEqual(providedBuffer, expectedBuffer);
    } catch (err) {
        return false; // Handle invalid hex strings
    }
}
}),
"[project]/server/tracking-handler.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/crypto [external] (crypto, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$s2s$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/s2s.ts [app-route] (ecmascript)");
;
;
;
;
async function handleTracking(req, projectCodeParam) {
    ...
    try {
        ...
        if (isDuplicate) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].createActivityLog({
                ...
                meta: {
                    details: `Duplicate RID detected: ${supplierRid} for ${supplierCode} on ${projectCode}`
                }
            });
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/pages/duplicate?${params.toString()}`, req.url));
        }
...
"[project]/app/r/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$tracking$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/tracking-handler.ts [app-route] (ecmascript)");
;
async function GET(req, { params }) {
    const { code } = await params;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$tracking$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleTracking"])(req, code);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__17b0cde9._.js.map