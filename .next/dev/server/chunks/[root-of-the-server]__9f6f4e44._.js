...
"[project]/server/callback-handler.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function handleCallback(req, status) {
    const url = new URL(req.url);
    const oi_session = url.searchParams.get("oi_session");
    if (!oi_session) {
        return new Response("Missing oi_session", {
            status: 400
        });
    }
    const respondent = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getRespondentBySession(oi_session);
    if (!respondent) {
    ...
    if (finalStatus !== 'security-terminate') {
        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].updateRespondentStatus(respondent.oiSession, finalStatus);
    }
    // Log Activity
    await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].createActivityLog({
        oiSession: respondent.oiSession,
        ...
        eventType: 'callback',
        meta: {
            details: `Received ${status} callback from client.`
        }
    });
    // Calculate LOI
...
"[project]/app/quotafull/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$callback$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/callback-handler.ts [app-route] (ecmascript)");
;
async function GET(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$callback$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleCallback"])(req, "quotafull");
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__9f6f4e44._.js.map